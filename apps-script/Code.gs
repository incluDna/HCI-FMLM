...
function appendSatisfaction_(spreadsheet, payload) {
  ...
  sheet.appendRow([
    ...
    payload.satisfaction.overall_decision_support_preferred_interface_type,
    payload.satisfaction.overall_decision_support_baseline_vs_prototype,
    payload.satisfaction.overall_preference_alignment,
    payload.satisfaction.overall_preference_alignment_preferred_interface_type,
    payload.satisfaction.overall_preference_alignment_baseline_vs_prototype,
    payload.satisfaction.overall_clarity,
    payload.satisfaction.overall_clarity_preferred_interface_type,
    payload.satisfaction.overall_clarity_baseline_vs_prototype,
    payload.satisfaction.overall_intention_to_use,
    payload.satisfaction.overall_intention_to_use_preferred_interface_type,
    payload.satisfaction.overall_intention_to_use_baseline_vs_prototype,
    payload.satisfaction.app_a_interface_type,
    payload.satisfaction.app_b_interface_type,
